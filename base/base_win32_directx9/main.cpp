...
int main(int, char**)
{
    ...
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("ImGui Base by landon-dev"), WS_SYSMENU | WS_CAPTION | WS_MINIMIZEBOX, 100, 100, windowX, windowY, NULL, NULL, wc.hInstance, NULL);
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::SetWindowSize(ImVec2(windowX - 16, windowY - 39));
